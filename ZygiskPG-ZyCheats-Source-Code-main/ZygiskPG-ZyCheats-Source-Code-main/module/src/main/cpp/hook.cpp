...
void* (SkinName$firstPersonControl)(void* ref) {
    if (ref != nullptr) {
        return *(void **) ((uint64_t) ref + 0x1E0);
    }
}
...
void* (Player_move_c$photonView)(void* ref) {
    if (ref != nullptr) {
        return *(void **) ((uint64_t) ref + 0x3D0);
    }
}

void* (Player_move_c$skinName)(void* ref) {
    if (ref != nullptr) {
        return *(void **) ((uint64_t) ref + 0x658);
    }
}
...
void Pointers() {
    addGraffiti = (void(*)(void*, monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x164425C")));
    addWeaponSkin = (void(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x21905B4")));
    addWeaponSkin2 = (void(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x21902CC")));
    addSkin = (void(*)(void*, monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x1BAC7B0")));
  ...
  //  setString = (void(*)(monoString*, monoString*)) (void*) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x4541E00")));
   // getID = (monoString*(*)()) (monoString*) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x4363374")));
    setID = (void(*)(monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x4DB4930")));//search for AccountCreated

    setIDN = (void(*)(void*, monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x46D0574")));//search for Texture2D texture2D = new Texture2D(64, 32, TextureFormat.RGBA32, num != 0L); in networkstarttable
   ...
   // buyButtonHandle = (void(*)(void*, monoString*)) (void*) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x38D2C88")));
    ...
    File$ReadAllLines = (monoArray<monoString*> *(*)(monoString*)) (monoArray<monoString*>*) (g_il2cppBaseMap.startAddress + string2Offset("0x3350154"));
    Application$persistentDataPath = (monoString*(*)()) (monoString*) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x46C8E74")));
    File$Exists = (bool(*)(monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x334EE68")));
    provideRoyaleItem = (void(*)(monoString*, bool*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x3DABD80")));//search for GlidersInfo.GLIDER_EQUIPPED_KEY and find the right method in that class
    providePet = (void(*)(monoString*, int*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x3E0BC40")));//search for [TEST] call StoreKitEventListener.CheckIfFirstTimePayment() and find the method in the class
    buyArmor = (void(*)(void* instance, int*, int*, monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x1B7D8E4")));//search Armor_Army_1 find the one from Progress and above it its the one
    provideGadget = (void(*) (monoString*, int*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x259100C")));//search Provid_eGadget gadget_Id == null
    targetFrameRate = (void(*)(int*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x46C8FA0")));//search for SetTargetFrameRate in field/strings
    addWear = (void(*)(int*, monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x17344F0"))); // search for WearScriptableObject_GENERATED
    ...
    LoadLevel = (void(*)(monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x4A6D228")));//search LoadScene
    OpenURL = (void(*)(monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x46C8F3C")));//search OpenURL
    setSomething = (void(*) (void*, monoString*, int*, int*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x1B92B1C")));//search up ClanLootBoxPoints and look for Progress
    SendChat = (void(*) (void*, monoString*, bool, monoString *)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x45A088C")));//search SendChat
    addWeapon = (void(*) (void*, monoString*, int*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x4D134E4")));//search AddW_eaponToInv rec == null , tag =  {0}
    SetMasterClient = (bool(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset("0x4EAD4B0"));//search SetMasterClient in strings
    get_LocalPlayer = (void*(*)()) (g_il2cppBaseMap.startAddress + string2Offset("0x4EA5ED4"));//find the photonplayer class name and just search it until you find something similiar to the old version
    DestroyPlayerObjects = (void (*)(void *)) (g_il2cppBaseMap.startAddress + string2Offset("0x4EAD96C"));//search DestroyPlayerObjects in strings
    PhotonNetwork_playerListothers = (monoArray<void **> *(*)()) (g_il2cppBaseMap.startAddress + string2Offset("0x4EA61E4"));//same steps as localplayer, its the 2nd array, so below the first array method you see
    EnableXray = (void(*)(void*, bool)) (g_il2cppBaseMap.startAddress + string2Offset("0x4592A60"));//search "use_zoom"
    BuyStickerPack = (void(*)(int*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x3D2B428")));//look in StickersController, compare and find the right function
    JoinToRoomPhotonAfterCheck = (void(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x21295D4")));//not obfuscated just search
    JoinToRoomPhotonAfterCheckCustom = (void(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x34708E8")));//not obfuscated just search
    // UNITY FUNC
    Component$get_gameObject = (void*(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x46BE058")));
    Component$get_tag = (monoString*(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x46BE530")));
    Component$get_transform = (void*(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x46BE01C")));
   // CharacterController$set_radius = (void(*)(void*, float)) (void*) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x457B544")));
    ...
    // OK ITS FINE NOW //
    GameObject$get_active = (bool(*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x46A8AD0")));
    GameObject$set_active = (void(*)(void*, bool)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x46A8B0C")));
    Transform$get_forward = (Vector3 (*)(void*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x46CA13C")));
    string$StartsWith = (bool (*)(monoString*, monoString*)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x47364A8")));
   ...
   //get_rotation = (void (*)(void*)) (void*) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x4410CB4")));
    ...
    EnableJetpack = (void (*)(void*, bool)) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x45A6E30")));//search for AddBonusAfterKillPlayerRPC, PhotonTargets.Others in player_move_c
 //   isDead = (bool (*)(void*)) (void*) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x143726C")));
    SetXrayShader = (void(*)(void*, bool)) (g_il2cppBaseMap.startAddress + string2Offset("0x45BB208"));//in player_move_c search for .XRay, below is the methos
    getDeviceUniqueIdentifier = (monoString*(*)()) (g_il2cppBaseMap.startAddress + string2Offset(OBFUSCATE("0x46A1000")));
...
void WeaponSounds(void* obj){
    if(obj != nullptr){
        if(damage != NULL){
            *(float*)((uint64_t) obj + 0x3A4) = damage;//shotgunMaxDamageDistance
            *(float*)((uint64_t) obj + 0x3A8) = damage;//shotgunMinDamageCoef
            *(float*)((uint64_t) obj + 0x3AC) = damage;//shotgunOverDamageDistance
            *(float*)((uint64_t) obj + 0x3B0) = damage;//shotgunOverDamageCoef
        }
        ...
        if(gundmg){
            *(bool*)((uint64_t) obj + 0x3B4) = true;//isSectorsAOE
            *(float*)((uint64_t) obj + 0x3C4) = 2.5;//sectorsAOEDamageMultiplierFront
            *(float*)((uint64_t) obj + 0x3C8) = 2.5;//sectorsAOEDamageMultiplierSide
            *(float*)((uint64_t) obj + 0x3C0) = 2.5;//sectorsAOEDamageMultiplierBack
            *(float*)((uint64_t) obj + 0x3CC) = 16;//sectorsAOERadiusSectorsAoE
        }

        if(invisible){
            *(bool*)((uint64_t) obj + 0x37D) = true;//isInvisibleAfterRespawn
            *(float*)((uint64_t) obj + 0x380) = 9999999;//isInvisibleAfterRespawnTime
        }

        if(ignorereflect) {
            *(bool *) ((uint64_t) obj + 0x309) = false;//isDamageReflection
            *(bool *) ((uint64_t) obj + 0x30A) = false;//isDamageAbsortion
        }
        ...
        if(catspam){
            *(bool*)((uint64_t) obj + 0x690) = false;//is3CatSpam
        }

        if(portalBull){
            *(bool*)((uint64_t) obj + 0x3D0) = true;//portalGun
            *(bool*)((uint64_t) obj + 0x3D1) = true;//isPortalExplosion
          //  *(int*)((uint64_t) obj + 0x3C0) = 1;//isPortalExplosion
        }

        if(charm){
            *(bool*)((uint64_t) obj + 0x270) = true;//isCharm
            *(float*)((uint64_t) obj + 0x274) = 99999;//charmTime
        }
        ...
        if(fte){
            *(bool*)((uint64_t) obj + 0x244) = true;//fireImmunity
            *(bool*)((uint64_t) obj + 0x245) = true;//toxicImmunity
            *(bool*)((uint64_t) obj + 0x246) = true;//toxicImmunity
        }

        if(snowstormbull){
            *(bool*)((uint64_t) obj + 0x2F4) = true;//snowStorm
            *(float*)((uint64_t) obj + 0x2F8) = 6;//snowStormBonusMultiplier
            if(snowstormbullval != NULL && !kniferange){
                *(float*)((uint64_t) obj + 0xDC) = snowstormbullval; // shootDistance
                *(float*)((uint64_t) obj + 0x648) = snowstormbullval; // range
            }
        }

        if(playerScore){
            *(bool*)((uint64_t) obj + 0x384) = true;//isBuffPoints
            *(float*)((uint64_t) obj + 0x390) = 99999;//buffBonusPointsForKill
        }

        if(polymorph){
            *(bool*)((uint64_t) obj + 0x2E4) = true;//polymorpher
            *(float*)((uint64_t) obj + 0x2E8) = 999999999;//polymorphDuarationTime
            *(int*)((uint64_t) obj + 0x3D0) = 0;//polymorphType
            *(float*)((uint64_t) obj + 0x2F0) = 22340000;//polymorphMaxHealth
            harpoonBull = true;
        }

        if(enemymarker){
            *(bool*)((uint64_t) obj + 0x247) = true;//enemyMarker
            *(bool*)((uint64_t) obj + 0x248) = true;//enemyMarkerWhenShot
            *(bool*)((uint64_t) obj + 0x249) = true;//enemyMarkerWhenAiming
            *(float*)((uint64_t) obj + 0x24C) = 0;//enemyMarketChargeTime
        }

        if(electric){
            *(bool*)((uint64_t) obj + 0x424) = true;//isElectricShock
            *(float*)((uint64_t) obj + 0x428) = 99999;//electricShockCoeff
            *(float*)((uint64_t) obj + 0x42C) = 99999;//electricShockTime
        }


        *(bool*)((uint64_t) obj + 0x468) = false;//isDaterWeapon
        *(bool*)((uint64_t) obj + 0x5C0) = false;//campaignOnly

        if(gbullets){
            *(bool*)((uint64_t) obj + 0x46D) = true;//isGrenadeWeapon
        }

        if(reflections){
            *(bool*)((uint64_t) obj + 0x309) = true;//isDamageReflection
            *(bool*)((uint64_t) obj + 0x30A) = false;//isDamageAbsorption
            *(float*)((uint64_t) obj + 0x30C) = -99999;//damageReflectionValue
        }

        if(firerate){
            *(int*)((uint64_t) obj + 0x600) = 999;
        }

        if(flamethrower){
            *(bool*)((uint64_t) obj + 0x344) = true;//flamethrower
        }

        if(blindness){
            *(bool*)((uint64_t) obj + 0x264) = true;//isBlindEffect
            *(float*)((uint64_t) obj + 0x26C) = 99999;//blindness
        }

        if(crithit){
            *(float*)((uint64_t) obj + 0x478) = 9999;//criticalHitCoef
            *(float*)((uint64_t) obj + 0x474) = 9999;//criticalHitChance
        }

        if(doublejump){
            *(bool*)((uint64_t) obj + 0x46F) = true;//isDoubleJump
        }

        if(ammo){
            *(bool*)((uint64_t) obj + 0x461) = true;//isUnlimitedAmmo
        }

        if(coindrop){
            *(bool*)((uint64_t) obj + 0x328) = true;//isCoinDrop
            *(float*)((uint64_t) obj + 0x32C) = 9999;//coinDropChance
        }

        if(kniferange){
            *(bool*)((uint64_t) obj + 0x361) = true;//isFrostSword
            *(float*)((uint64_t) obj + 0x364) = 5;//frostDamageMultiplier
            *(float*)((uint64_t) obj + 0x368) = 999999;//frostRadius
        }
        ...
        if(kniferangesex && !kniferange){
            ...
            *(float*)((uint64_t) obj + 0x648) = MAXFLOAT; // range
        }
        ...
        if(harpoonBull) {
            *(bool *) ((uint64_t) obj + 0x2B4) = true;//harpoon
            *(float *) ((uint64_t) obj + 0x2D8) = 99999;//harpoonMaxDistance
            *(float *) ((uint64_t) obj + 0x2D0) = 99999;//harpoonDecaySpeed
        }
        if(jumpdisable){
        ...
        if(slowdown){
            *(bool*)((uint64_t) obj + 0x220) = true;//isSlowdown
            *(float*)((uint64_t) obj + 0x224) = -999999999;//slowdownCoeff
            *(float*)((uint64_t) obj + 0x228) = 999999;//slowdownTime
        }

        if(headmagnify){
            *(bool*)((uint64_t) obj + 0x25C) = true;//isHeadMagnifier
            *(float*)((uint64_t) obj + 0x260) = 999999;//headMagnifierTime
        }
      ...
      /*  if(spleef){
        ...
        if(god){
            *(bool*)((uint64_t) obj + 0x3E4) = true;//isArmorRegeneration
            *(float*)((uint64_t) obj + 0x3E8) = 9999;//armorRegenerationPercent
            *(float*)((uint64_t) obj + 0x3EC) = 0;//armorRegenerationTime
            ...
            *(bool*)((uint64_t) obj + 0x594) = true;//healingArea
            *(bool*)((uint64_t) obj + 0x595) = true;//healingHimSelf
            //*(float*)((uint64_t) obj + 0x558) = 9999;//radiusHealing
        }

        if(mythic){
            *(int*)((uint64_t) obj + 0x64C) = 5;
            *(int*)((uint64_t) obj + 0x670) = 69420;
        }
...
{
    bool (*isEnemy)(void *player, void *enemy) = (bool(*)(void *, void *))(g_il2cppBaseMap.startAddress + string2Offset("0x46EC664")); // PlayerDamageable$$IsEnemyTo
...
{
    bool (*IsDead)(void *player) = (bool(*)(void *))(g_il2cppBaseMap.startAddress + string2Offset("0x46EC9DC")); // PlayerDamageable$$IsDead
...
void(PlayerMoveC)(void* obj){
    if(obj != nullptr) {
        if (spamchat) {
            SendChat(obj, CreateIl2cppString("YouTube @buccimu チャンネル登録しろ/sub"), false,CreateIl2cppString("0"));
        }
        ...
        if (xray) {
            ...
            *(bool *) ((uint64_t) obj + 0x720) = true; // search ZombiManager then its above
        }
        ...
        if (gadgetsEnabled) {
            *(bool *) ((uint64_t) obj + 0xDD2) = false;//search for Action, the field should be under the gadget class
        }

        void *SkinName = *(void **) ((uint64_t) obj + 0x660);
        if (SkinName != nullptr) {
            if (IsMine(SkinName)) {
                MyPlayer = SkinName;
                enemyPlayer = obj;
...
void PixelTime(void *obj) {
    if (obj != nullptr) {
        ...
        if (isDiscordPressed) {
            OpenURL(CreateIl2cppString(OBFUSCATE("https://discord.gg/jcSu9nMEHs")));
...
void Hooks() {
        HOOK("0x46E66D8", networkStartTable, old_networkStartTable);
        HOOK("0x4C19040", formatString, old_formatString);
        //HOOK("0x2135C9C", updateSkinButtons, old_updateSkinButtons);
        HOOK("0x42C1DC8", PixelTime, old_PixelTime);
       // HOOK("0x38C1638", ShopNGUIController, old_ShopNGUIController);
        HOOK("0x1B5A244", WeaponSounds, oldWeaponSounds); //23.5.2
        HOOK("0x4D0F2FC", WeaponManager, old_WeaponManager);
        HOOK("0x45BFA9C", PlayerMoveC, oldPlayerMoveC);
        HOOK("0x212AB48", HandleJoinRoomFromEnterPasswordBtnClicked, old_HandleJoinRoomFromEnterPasswordBtnClicked);
        HOOK("0x34706E8", CustomHandleJoinRoomFromEnterPasswordBtnClicked, old_CustomHandleJoinRoomFromEnterPasswordBtnClicked);
        HOOK("0x2259FA0", Speed, oldSpeeds);
        HOOK("0x25845D0", gadgetDuration, oldGadgetDuration);//search for gadget_combat_spinner and find the float via analyze
        HOOK("0x186D5BC", FirstPersonControllSharp, oldFirstPersonControllerSharp);
        // HOOK("0x47BC280", SendChatHooked, old_SendChatHooked);
        HOOK("0x41E913C", petSpeed, oldPetSpeeds);//PetInfo
        HOOK("0x41E8ECC", petHealth, oldpetHealth);
        HOOK("0x41E9004", petAttack, oldpetAttack);
        //HOOK("0x1B04ED4", TeammateHealMultiplier, oldTeammateHealMultiplier);
}

void Patches() {
    PATCH_SWITCH("0x39FD4C8", "20008052C0035FD6", wepSkins6);

    PATCH_SWITCH("0x46E4F58", "C0035FD6", spoofMe3); // networkstarttable.start() -> used there
    PATCH_SWITCH("0x2524C50", "00008052C0035FD6", modUp); //search OfferMiniIcons/module and look for the right method in the class
    PATCH_SWITCH("0x3D43664", "00008052C0035FD6", clanEnergy); // search Energy
    PATCH_SWITCH("0x3EA8D48", "00008052C0035FD6", bundles); // just analyze LobbyItemsBundle and compare it to the other one to find
    PATCH_SWITCH("0x3EA9058", "00008052C0035FD6", bundles); // after you find the class ^^^^^^^^^^^^ search for LobbyItemBuff and get the set
    PATCH_SWITCH("0x41074C4", "20008052C0035FD6", bundles);
   // PATCH_SWITCH("0x38C5DAC", "20008052C0035FD6", shopnguitest);
    PATCH_SWITCH("0x3D44478", "00008052C0035FD6", clanparts); // just compare it
    PATCH_SWITCH("0x3D4396C", "00008052C0035FD6", clanparts); // just compare it
   // PATCH_SWITCH("0x310DB24", "20008052C0035FD6", wepSkins);
   // PATCH_SWITCH("0x3789DA0", "20008052C0035FD6", showWepSkins);
    PATCH_SWITCH("0x45EB734", "C0035FD6", god); // search int viewID and you'll find it (player_move_c)
    PATCH_SWITCH("0x3EA3204", "C0035FD6", god); // search for SkinName skinName = this.mySkinName; dont panic, itll be used alot, try to find the one which only takes SkinName and has the argument CategoryNames
    PATCH_SWITCH("0x4F5BC84", "C0035FD6", god);//OnTriggerEnter
    PATCH_SWITCH("0x4F5B3F4", "C0035FD6", god);//OnControllerColliderHit
    PATCH_SWITCH("0x1CB2D44", "A0F08FD2C0035FD6", maxLevel); // go to PlayerPanel.Update and the property inside the method should be lvl
  ...
  //  PATCH_SWITCH("0x305D3CC", "802580D2C0035FD6", cWear);
    PATCH_SWITCH("0x258EF14", "00008052C0035FD6", gadgetUnlock);//search for GadgetsContent/GadgetsArmoryInfoPreview/empty below is the method
    PATCH_SWITCH("0x2257280", "603E8012C0035FD6", modKeys);//search for EventCurrency and try finding the right class or just use "C"
    PATCH_SWITCH("0x4DCCEEC", "C0035FD6", tgod);//all the minus live
    PATCH_SWITCH("0x1E3EC6C", "C0035FD6", tgod);
    PATCH_SWITCH("0x1E43DC4", "C0035FD6", tgod);
    PATCH_SWITCH("0x45DCD2C", "C0035FD6", removedrone);//player_move_c and DroneController droneController;
    PATCH_SWITCH("0x45DCDE4", "C0035FD6", removedrone);//right below this ^^^
    PATCH_SWITCH("0x1B5B03C", "200080D2C0035FD6", crithit);//nexthitcritical in weaponsounds
    PATCH_SWITCH("0x1E704B4", "200080D2C0035FD6", couponClicker);//this requires abit of effort and luck, go to CollectButtonPressed the class is in the typeof handle then just try to match the bool to the one before by comparing it
    PATCH_SWITCH("0x488A77C", "00F0271EC0035FD6", reload);//mask_hitman_1_up1 in strings and the method with weaponsounds
    PATCH_SWITCH("0x25845D0", "000080D2C0035FD6", gadgetcd);//search Action in player_move_c find the 2 fields with action exactly then above some bools should be a classname which is GADGET
    PATCH_SWITCH("0x41E8754", "00008052C0035FD6", prespawntime);//search RespawnTime in petinfo
    //    PATCH_SWITCH("0x2F87D18", "00FA80D2C0035FD6", initParams); // do it 0x2F87D18 0x2F944C8 0x2F87D98 0x2F95CF8
    PATCH_SWITCH("0x2520E38", "80388152C0035FD6", collectibles); //search [{0}]{1}:{2}:{3} and just compare
    PATCH_SWITCH("0x155DEC4", "00008052C0035FD6", teamkill);//compare isTeamMode to 16.6.1  version goodluck (hint it should be the same as in 16.6.1)
    PATCH_SWITCH("0x155F23C", "00008052C0035FD6", teamkill);//look for Random in PlayerBotInstance, you'll find the bool at the end of the method
    ...
    PATCH("0x449C240", "C0035FD6");//antiban -  search DeveloperConsoleController.HandleBanUs and the method inside is the one
    PATCH("0x4C19B98", "000080D2C0035FD6");//Swear filter search for fuck
    PATCH("0x3386820", "200080D2C0035FD6");//ValidateNickName
    PATCH("0x3386A60", "200080D2C0035FD6");//ValidateNickNameNoAnalytics
    PATCH("0x3B37C1C", "C0035FD6");//Search for DataSystem.DataValidation and the cctor inside the first class
}

void DrawMenu(){
    static ImVec4 clear_color = ImVec4(0.45f, 0.55f, 0.60f, 1.00f);
    {
        ImGui::Begin(OBFUSCATE("zyCheats PG3D - Original (23.5.2) - BUCCI"));
        if (isValidAuth && isAuth()) {
            ImGuiTabBarFlags tab_bar_flags = ImGuiTabBarFlags_FittingPolicyResizeDown;
            if (ImGui::BeginTabBar("Menu", tab_bar_flags)) {
                if (ImGui::BeginTabItem(OBFUSCATE("アカウント"))) {
                    if (ImGui::Button(OBFUSCATE("リロード")))
                    {
                        loadMenu = true;
                    }
                    ImGui::Checkbox(OBFUSCATE("レベル65"), &maxLevel);
                    ImGui::TextUnformatted((OBFUSCATE("レベル3以上の時に使うことをお勧めします")));
                    ImGui::Checkbox(OBFUSCATE("モジュールパーツなしでレベルUP"), &modUp);
                    ImGui::TextUnformatted((OBFUSCATE("コインは必要です")));
                    ImGui::Checkbox(OBFUSCATE("クランエネルギー無限"), &clanEnergy);
                    ImGui::TextUnformatted((OBFUSCATE("無限に置けるわけではありません")));
                    ImGui::Checkbox(OBFUSCATE("nothing"), &collectibles);
                    ImGui::TextUnformatted(OBFUSCATE("nothing"));
                    ImGui::Checkbox(OBFUSCATE("ガジェットロック解除"), &gadgetUnlock);
                    ImGui::TextUnformatted(OBFUSCATE("これを使うことはお勧めしません"));
                    ImGui::Checkbox(OBFUSCATE("全バンドル無料"), &bundles);
                    ImGui::TextUnformatted(OBFUSCATE("無料で課金バンドルを入手できます"));
                    ImGui::Checkbox(OBFUSCATE("全ロビーアイテム表示"), &lobbyItems);
                    ImGui::TextUnformatted(OBFUSCATE("非表示のアイテムを入手できます"));
                    ImGui::Checkbox(OBFUSCATE("クランパーツ無料"), &clanparts);
                    ImGui::TextUnformatted(OBFUSCATE("簡単にクランを強化できます"));
                    ImGui::Checkbox(OBFUSCATE("スキンロック解除"), &wearUnlocker);
                    ImGui::TextUnformatted((OBFUSCATE("nothing")));
                    ImGui::Checkbox(OBFUSCATE("武器スキンロック解除"), &wepSkins6);
                    ImGui::TextUnformatted((OBFUSCATE("全武器スキンを買うことができます")));
                    ImGui::Checkbox(OBFUSCATE("鍵チェスト無料"), &modKeys);
                    ImGui::TextUnformatted(OBFUSCATE("必要鍵数が-500になります (このチートがONの時は武器庫で武器を購入しないでください)"));
                    ImGui::Checkbox(OBFUSCATE("アイテム表示"), &showItems);
                    if (ImGui::Button(OBFUSCATE("イースター ステッカー パックを購入する"))) {
                        isBuyEasterSticker = true;
                    }
                    ImGui::Checkbox(OBFUSCATE("ID -1"), &spoofMe3);
                    ImGui::TextUnformatted(OBFUSCATE("他のプレイヤーからあなたのIDを隠します"));
                    if (ImGui::CollapsingHeader(OBFUSCATE("アンロック"))) {
                        ImGui::TextUnformatted((OBFUSCATE("少しの間フリーズします")));
                        ImGui::TextUnformatted(OBFUSCATE("機能しなかった場合もう一度使用してください"));
                        if (ImGui::Button(OBFUSCATE("全アーマー追加"))) {
                            addAllArmors = true;
                        }
                        if (ImGui::Button(OBFUSCATE("全ガジェット追加"))) {
                            addAllGadgets = true;
                        }
                        if (ImGui::Button(OBFUSCATE("全プレイヤースキン追加"))) {
                            addAllSkins = true;
                        }
                        if (ImGui::Button(OBFUSCATE("全ペット追加"))) {
                            addAllPets = true;
                        }
                        if (ImGui::Button(OBFUSCATE("全スプレー追加"))) {
                            isAddGraffitis = true;
                        }
                        // if (ImGui::Button(OBFUSCATE("Add All Weapon Skins"))) {
                        //     addAllWepSkins = true;
                        // }
                        if (ImGui::CollapsingHeader(OBFUSCATE("ロイヤルアイテムロック解除")))
                        {
                            if (ImGui::Button(OBFUSCATE("追加 1/4"))) {
                                addAllRoyale1 = true;
                            }
                            if (ImGui::Button(OBFUSCATE("追加 2/4"))) {
                                addAllRoyale2 = true;
                            }
                            if (ImGui::Button(OBFUSCATE("追加 3/4"))) {
                                addAllRoyale3 = true;
                            }
                            if (ImGui::Button(OBFUSCATE("追加 4/4"))) {
                                addAllRoyale4 = true;
                            }
                        }
                        if (ImGui::CollapsingHeader(OBFUSCATE("武器ロック解除")))
                        {
                            if (ImGui::CollapsingHeader(OBFUSCATE("一気に追加") {
                                if (ImGui::Button(OBFUSCATE("0-150 追加"))) {
                                    isAddWeapons = true;
                                }
                                if (ImGui::Button(OBFUSCATE("151-300 追加"))) {
                                    isAddWeapons2 = true;
                                }
                                if (ImGui::Button(OBFUSCATE("301-450 追加"))) {
                                    isAddWeapons3 = true;
                                }
                                if (ImGui::Button(OBFUSCATE("451-600 追加"))) {
                                    isAddWeapons4 = true;
                                }
                                if (ImGui::Button(OBFUSCATE("601-750 追加"))) {
                                    isAddWeapons5 = true;
                                }
                                if (ImGui::Button(OBFUSCATE("751-900 追加"))) {
                                    isAddWeapons6 = true;
                                }
                                if (ImGui::Button(OBFUSCATE("901-1050追加"))) {
                                    isAddWeapons7 = true;
                                }
                                if (ImGui::Button(OBFUSCATE("1051-1194 追加"))) {
                                    isAddWeapons8 = true;
                                }
                            }
                            ImGui::ListBox(OBFUSCATE("武器"), &selectedNormalWeapon, wepList,IM_ARRAYSIZE(wepList), 4);
                            if (ImGui::Button(OBFUSCATE("追加"))) {
                                isAddWepPress2 = true;
                            }
                            ImGui::ListBox(OBFUSCATE("入手不可な武器"), &selectedWeapon, goofyWeps,IM_ARRAYSIZE(goofyWeps), 4);
                            if (ImGui::Button(OBFUSCATE("追加"))) {
                                isAddWepPress = true;
                            }
                        }
                    }
                    if (ImGui::CollapsingHeader(OBFUSCATE("通貨系"))) {
#ifdef BIGSEX
                        ImGui::SliderInt(OBFUSCATE("額"), &amountws, 0, 100000);
#else
                        ImGui::SliderInt(OBFUSCATE("額"), &amountws, 0, 10000);//dont fucking change it you cocksucker, make it how you want in a dev build but for users its 5000
#endif
                        ImGui::TextUnformatted(OBFUSCATE("5000以内にすることをお勧めします"));
                        ImGui::ListBox(OBFUSCATE("種類    "), &selectedCur, curList,IM_ARRAYSIZE(curList), 4);
                        if (ImGui::Button(OBFUSCATE("追加"))) {
                ...
                if (ImGui::BeginTabItem(OBFUSCATE("プレイヤー"))) {
                    ImGui::Checkbox(OBFUSCATE("無敵"), &god);
                    ImGui::TextUnformatted(OBFUSCATE("他のプレイヤーから見えなくなります"));
                    ImGui::Checkbox(OBFUSCATE("ダブルジャンプ可能"), &doublejump);
                    //  ImGui::Checkbox(OBFUSCATE("Noclip"), &noclip);
                    if(ImGui::Button(OBFUSCATE("ジェットパックON"))){
                        ninjaJump = true;
                    }
                    ImGui::Checkbox(OBFUSCATE("スピードUP"), &speed);
                    ImGui::Checkbox(OBFUSCATE("透明"), &invisible);
                    ImGui::TextUnformatted(OBFUSCATE("リスポーン時透明になります"));
                    ImGui::Checkbox(OBFUSCATE("プレイヤー追加"), &isAdded);
                    ImGui::TextUnformatted(OBFUSCATE("nothing"));
                    ImGui::SliderFloat(OBFUSCATE("ジャンプ高さ"), &jumpHeight, 0.0f,2.5f);
                    ImGui::EndTabItem();
                }
                if (ImGui::BeginTabItem(OBFUSCATE("ゲーム"))) {
                    ...
                    ImGui::Checkbox(OBFUSCATE("全員キル"), &kniferange);
                    ImGui::TextUnformatted(OBFUSCATE("OFFにならない場合は武器を持ち替えてください"));
                    ImGui::Checkbox(OBFUSCATE("味方キル可能"), &teamkill);
                    ImGui::TextUnformatted(OBFUSCATE("デスマッチみたいになります (自分だけ)"));
                    ImGui::Checkbox(OBFUSCATE("チャットスパム"), &spamchat);
                    ImGui::Checkbox(OBFUSCATE("コインドロップ"), &coindrop);
                    ImGui::TextUnformatted(OBFUSCATE("キルしたときに必ずコインをドロップします (全員反映)"));
                    ImGui::Checkbox(OBFUSCATE("全員バグる", &xrayApplied);
                    ImGui::TextUnformatted(OBFUSCATE("全員スコープを覗いた状態になります"));
                    ImGui::Checkbox(OBFUSCATE("キルスコア追加"), &playerScore);
                    ImGui::TextUnformatted(OBFUSCATE("1キル200万くらい"));
                    if (ImGui::Button(OBFUSCATE("自分以外クラッシュ"))) {
                        destroy = true;
                    }
                    if (ImGui::CollapsingHeader(OBFUSCATE("ガジェット系"))) {
                        ImGui::Checkbox(OBFUSCATE("ドローン無敵"), &removedrone);
                        ImGui::TextUnformatted(OBFUSCATE("ドローン系ガジェットが消えなくなります (2個以上使わないでください)"));
                        ImGui::Checkbox(OBFUSCATE("ガジェットクールダウン時間なし"), &gadgetcd);
                        ImGui::TextUnformatted(OBFUSCATE("このチートがONになっている時はガジェットを変えないでください"));
                        ImGui::Checkbox(OBFUSCATE("ガジェット効果時間無限"), &gadgetduration);
                        ImGui::TextUnformatted(OBFUSCATE("nothing"));
                        ImGui::Checkbox(OBFUSCATE("タレット無敵"), &tgod);
                        ImGui::TextUnformatted(OBFUSCATE("タレットが壊れなくなります"));
                    }
                    if (ImGui::CollapsingHeader(OBFUSCATE("ペット系"))) {
                        ImGui::Checkbox(OBFUSCATE("無敵"), &pgod);
                        ImGui::Checkbox(OBFUSCATE("スピードUP"), &pspeed);
                        ImGui::Checkbox(OBFUSCATE("1確キル"), &pdamage);
                        ImGui::Checkbox(OBFUSCATE("即時リスポーン"), &prespawntime);
                        ImGui::Checkbox(OBFUSCATE("壁貫通"), &pnoclip);
                        ImGui::TextUnformatted(OBFUSCATE("壁を通り抜けて攻撃できるようになります"));
                    }
                    ImGui::EndTabItem();
                }
                if (ImGui::BeginTabItem(OBFUSCATE("武器系"))) {
                    ImGui::Checkbox(OBFUSCATE("クリティカル確定"), &crithit);
                    ImGui::TextUnformatted(OBFUSCATE("必ずクリティカルヒットします"));
                    ImGui::Checkbox(OBFUSCATE("弾薬無限"), &ammo);
                    ImGui::Checkbox(OBFUSCATE("ダメージUP"), &gundmg);
                    //   ImGui::Checkbox(OBFUSCATE("Fire-Rate"), &firerate);
                    ImGui::Checkbox(OBFUSCATE("即時リロード"), &reload);
                    ImGui::TextUnformatted(OBFUSCATE("リロードモーションが消えます"));
                    ImGui::SliderFloat(OBFUSCATE("サイレントエイムパワー"), &snowstormbullval, 0.0f,2000.0f);
                    ImGui::Checkbox(OBFUSCATE("サイレントエイム"), &snowstormbull);
                    ImGui::TextUnformatted(OBFUSCATE("適当に撃っても誰かにダメージを与えられます"));
                    ImGui::Checkbox(OBFUSCATE("無反動"), &recoilandspread);
                    ImGui::Checkbox(OBFUSCATE("強制スコープ"), &scopef);
                    ImGui::Checkbox(OBFUSCATE("近接範囲無限"),&kniferangesex);
                    ImGui::TextUnformatted(OBFUSCATE("どんな距離でもエイムを合わせれば攻撃できるようになります"));
                    if (ImGui::CollapsingHeader(OBFUSCATE("弾丸系"))) {
                        ImGui::Checkbox(OBFUSCATE("爆発弾"), &expbull);
                        ImGui::TextUnformatted(OBFUSCATE("どの武器も爆発します"));
                        ImGui::Checkbox(OBFUSCATE("レーザー弾"), &railbull);
                        ImGui::TextUnformatted(OBFUSCATE("どの武器も壁を貫通して攻撃できるようになります"));
                        ImGui::SliderInt(OBFUSCATE("反射弾"), &reflection, 0, 1000);
                        ImGui::TextUnformatted(OBFUSCATE("どの武器も反射します"));
                        ImGui::Checkbox(OBFUSCATE("変化弾"), &polymorph);
                        ImGui::TextUnformatted(OBFUSCATE("プレイヤーを羊に変えます"));
                        ImGui::Checkbox(OBFUSCATE("ハープーン弾"), &harpoonBull);
                        ImGui::TextUnformatted(OBFUSCATE("撃ったところに移動します"));
                        ImGui::Checkbox(OBFUSCATE("火炎弾"), &flamethrower);
                        ImGui::TextUnformatted(OBFUSCATE("相手を燃やします"));
                    }

                    if (ImGui::CollapsingHeader(OBFUSCATE("エフェクト軽"))) {
                        ImGui::Checkbox(OBFUSCATE("画面反転"), &ignorereflect);
                        ImGui::TextUnformatted(OBFUSCATE("nothing"));
                        ImGui::Checkbox(OBFUSCATE("チャーム"), &charm);
                        ImGui::TextUnformatted(OBFUSCATE("相手からのダメージを軽減します"));
                        ImGui::Checkbox(OBFUSCATE("電気ショック"), &electric);
                        ImGui::TextUnformatted(OBFUSCATE("nothing"));
                        ImGui::Checkbox(OBFUSCATE("盲目"), &blindness);
                        ImGui::TextUnformatted(OBFUSCATE("見えにくくします"));
                        ImGui::Checkbox(OBFUSCATE("スピードUPエフェクト"), &speedup);
                        ImGui::TextUnformatted(OBFUSCATE("エイムを合わせづらくなります"));
                        ImGui::Checkbox(OBFUSCATE("スロー"), &slowdown);
                        ImGui::TextUnformatted(OBFUSCATE("撃った相手の移動スピードが遅くなります"));
                        ImGui::Checkbox(OBFUSCATE("ジャンプ無効"), &jumpdisable);
                        ImGui::TextUnformatted(OBFUSCATE("nothing"));
                        ImGui::Checkbox(OBFUSCATE("頭巨大化"), &headmagnify);
                        ImGui::TextUnformatted(OBFUSCATE("nothing"));
                        ImGui::Checkbox(OBFUSCATE("ガジェット無効"), &gadgetdisabler);
                        ImGui::TextUnformatted(OBFUSCATE("nothing"));
                    }
                    ImGui::EndTabItem();
                }
                if (ImGui::BeginTabItem(OBFUSCATE("視覚系"))) {
                    ImGui::Checkbox(OBFUSCATE("発光"), &xray);
                    ImGui::TextUnformatted(OBFUSCATE("壁越しでも敵が見えます"));
                    ImGui::Checkbox(OBFUSCATE("マーカー"), &enemymarker);
                    ImGui::TextUnformatted(OBFUSCATE("nothing"));
                    ImGui::Checkbox(OBFUSCATE("クイックスコープ"), &quickscope);
                    ImGui::TextUnformatted(OBFUSCATE("nothing"));
                    //    ImGui::SliderFloat(OBFUSCATE("Field Of View"), &fovModifier, 0.0, 360.0);
                    ImGui::EndTabItem();
                }
                if (ImGui::BeginTabItem(OBFUSCATE("その他"))) {
                    ImGui::ListBox(OBFUSCATE("シーン"), &selectedScene, sceneList, IM_ARRAYSIZE(sceneList), 4);
                    if (ImGui::Button(OBFUSCATE("シーンをロード"))) {
